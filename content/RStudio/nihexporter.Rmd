...
3. Create a new project in RStudio by importing the github repository (File -> New Project -> Version Control -> Git).
  ...
  - In the `Git` panel in the lower right, you will see a button that says `master`. Click that and change it to `manuscript`. All of your changes will now be (and *should* be) saved to this branch.
