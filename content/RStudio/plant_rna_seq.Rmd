...
But you'll notice that these counts tables are *messy*, so our first charge is to make it `tidyr`. See how the plant, virus, hpi and replicate designations are column names? That makes for efficient data storage, but does not enable efficient data analysis.
